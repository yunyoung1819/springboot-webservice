...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        // given
        String title = "클린코드";
        String content = "깨끗하고 효율적인 코드를 작성하는 방법에 관한 책";
    ...
    public void Posts_수정된다() throws Exception {
        ...
        Posts savedPosts = postsRepository.save(Posts.builder()
                .title("객체지향의 사실과 오해")
                .content("객체지향 프로그래밍에 대한 책")
                .author("조영호")
                .build());

        Long updateId = savedPosts.getId();
        String expectedTitle = "객체지향의 사실과 오해 개정판-2";
        String expectedContent = "객체지향 프로그래멩에 대한 책 내용 개정판";
